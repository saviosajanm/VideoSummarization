...
class DSN(nn.Module):
    ...
    def __init__(self, in_dim=1024, hid_dim=256, num_layers=1, cell='lstm'):
        ...
        assert cell in ['lstm', 'gru', 'rnn', 'conv2d'], "cell must be either 'lstm' or 'gru'"
        if cell == 'lstm':
            ...
            self.rnn = nn.onv2d(in_dim, hid_dim, num_layers=num_layers, bidirectional=True, batch_first=True)
