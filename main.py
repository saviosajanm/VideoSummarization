...
parser.add_argument('--method', type=str, default='knapsack', help="method used in DSN")
...
def evaluate(model, dataset, test_keys, use_gpu):
    ...
    with torch.no_grad():
        ...
        for key_idx, key in enumerate(test_keys):
            ...
            machine_summary = vsum_tools.generate_summary(probs, cps, num_frames, nfps, positions, method=args.method)
            print(args.method, "---------------------------------------------------------------------------------------------------------")
